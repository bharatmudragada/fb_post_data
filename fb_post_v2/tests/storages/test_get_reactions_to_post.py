...
class TestGetReactionsToPost:
    ...
    def setup_data(self):
        ...
        self.post_reaction_1 = PostReactions.objects\
            .create(post=self.post, user=self.user_1, reaction_type="LOVE")
        self.post_reaction_2 = PostReactions.objects\
            .create(post=self.post, user=self.user_2, reaction_type="SAD")
