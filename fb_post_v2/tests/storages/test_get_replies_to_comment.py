...
class TestGetRepliesToComment:
    ...
    def setup_data(self):
        ...
        self.reply_1 = Comment.objects.create(
            post=self.post, user=self.user_1, commented_on=self.comment,
            comment_text="This is reply one")
        self.reply_2 = Comment.objects.create(
            post=self.post, user=self.user_1, commented_on=self.comment,
            comment_text="This is reply two")
