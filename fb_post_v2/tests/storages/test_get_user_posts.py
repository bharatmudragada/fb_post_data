...
class TestGetUserPosts:
    ...
    def setup_data(self):
        ...
        self.post_1 = Post.objects.create(user=self.user_1, post_content="This is first post")
        self.post_2 = Post.objects.create(user=self.user_1, post_content="This is second post")
        self.post_3 = Post.objects.create(user=self.user_2, post_content="This is third post")
