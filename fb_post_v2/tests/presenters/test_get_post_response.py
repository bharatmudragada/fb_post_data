...
class TestGetPostResponse:
    ...
    def setup_get_post_dto(self):
        post_dto = PostDTO(post_id=1, user_id=1, post_content='1',
                           created_time=datetime.datetime.now())
        posted_user_dto = UserDTO(user_id=1, name='user_1',
        ...
        get_post_dto = GetPostDTO(
            ...
            post_reaction_data=post_reaction_dto, comments=comments_dto_list,
    ...
    def test_get_user_response(self):
        ...
        user_dto = UserDTO(user_id=1, name='user_1',
    ...
    def test_get_reaction_response(self):
        ...
        response = json_presenter\
            .convert_reaction_stats_dto_to_dict(reaction_dto)
    ...
    def test_get_comment_response_with_out_replies(self):
        ...
        comment_dto = CommentDetailsDTO(
            comment_id=1, user=user_dto, commented_at=datetime.datetime.now(),
    ...
    def test_get_comment_response_with_replies(self):
        ...
        reply_dto = CommentDetailsDTO(
            comment_id=2, user=user_dto, commented_at=datetime.datetime.now(),
        ...
        comment_dto = CommentDetailsWithRepliesDTO(
            ...
            comment_content="This is a comment",
            comment_reactions=comment_reactions_dto,
            replies=[reply_dto], replies_count=1)
