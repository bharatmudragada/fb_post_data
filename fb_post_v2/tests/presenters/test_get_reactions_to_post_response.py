...
class TestGetReactionsToPostResponse:
    ...
    def test_get_reactions_to_post_response(self):
        ...
        reactions_dto_one = ReactionDetailsDTO(user_id=1, name='user_1', profile_pic_url='https://user_1.png', reaction_type="LOVE")
        reactions_dto_two = ReactionDetailsDTO(user_id=2, name='user_2', profile_pic_url='https://user_2.png', reaction_type="LIKE")
        reaction_dto_list = [reactions_dto_one, reactions_dto_two]

        json_presenter = JsonPresenter()
        response = json_presenter.get_reactions_to_post_response(reaction_dto_list)
