...
class TestGetRepliesToCommentResponse:
    ...
    def test_get_replies_to_comment(self):
        ...
        user_one_dto = UserDTO(user_id=1, name='user_1',
                               profile_pic_url='https://user_1.png')
        user_two_dto = UserDTO(user_id=2, name='user_2',
                               profile_pic_url='https://user_2.png')
        reply_one_dto = RepliesDTO(
            comment_id=1, user=user_one_dto, commented_at=datetime.now(),
            comment_content="This is first reply")
        reply_two_dto = RepliesDTO(
            comment_id=2, user=user_two_dto, commented_at=datetime.now(),
