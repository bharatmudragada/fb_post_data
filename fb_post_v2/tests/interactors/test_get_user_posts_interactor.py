...
from fb_post_v2.interactors.storages.post_storage import PostStorage, GetUserPostsDTO
...
class TestGetUserPosts(unittest.TestCase):
    ...
    def test_get_user_posts(self):
        ...
        user_posts_dto = create_autospec(GetUserPostsDTO)
        ...
        response = get_user_posts_interactor.get_user_posts(user_id)
