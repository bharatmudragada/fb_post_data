...
from fb_post_v2.interactors.storages.post_storage import PostStorage, \
    CommentReactionDTO, PostReactionDTO
...
class TestReactToComment(unittest.TestCase):
    ...
    def test_with_new_reaction(self):
        ...
        post_storage_mock.add_comment_reaction.return_value = \
            comment_reaction_dto
        presenter_mock.get_react_to_comment_response.return_value = \
            {"reaction_id": 1}
        ...
        post_storage_mock.add_comment_reaction.assert_called_once_with(
            1, 1, "LOVE")
        presenter_mock.get_react_to_comment_response.assert_called_once_with(
            comment_reaction_dto)
    ...
    def test_with_different_reaction(self):
        ...
        post_storage_mock.update_comment_reaction.return_value = \
            comment_reaction_dto
        presenter_mock.get_react_to_comment_response.return_value = \
            {"reaction_id": 1}
        ...
        post_storage_mock.update_comment_reaction.assert_called_once_with(
            1, 1, "LOVE")
        presenter_mock.get_react_to_comment_response.assert_called_once_with(
            comment_reaction_dto)
        assert response == {"reaction_id": 1}
    ...
    def test_with_same_reaction(self):
        ...
        post_storage_mock.delete_comment_reaction.return_value = \
            comment_reaction_dto
        presenter_mock.get_react_to_comment_response.return_value =\
            {"status": "reaction_deleted"}

        reaction_interactor = ReactionInteractor(
...
class TestReactToPost(unittest.TestCase):
    ...
    def test_with_different_reaction(self):
        ...
        post_storage_mock.update_post_reaction.assert_called_once_with(
            1, 1, "LOVE")
        presenter_mock.get_react_to_post_response.assert_called_once_with(
            post_reaction_dto)
        assert response == {"reaction_id": 1}
