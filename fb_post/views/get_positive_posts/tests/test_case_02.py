...
class TestCase02GetPositivePostsAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase02GetPositivePostsAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX, TEST_CASE, *args, **kwargs)
    ...
    def setup_data(self):
        ...
        self.post_reaction_2 = PostReactions.objects.create(post=self.post_1, user=self.user_2, reactionType="SAD")
    ...
    def test_case(self):
        ...
        super(TestCase02GetPositivePostsAPITestCase, self).test_case()
