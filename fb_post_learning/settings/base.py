"""
Django settings for fb_post_learning project.
...
ALLOWED_HOSTS = [
    "fb-post-learning-prod.apigateway.in",
    "fb-post-learning-alpha.apigateway.in",
...
WSGI_APPLICATION = 'fb_post_learning.wsgi.application'
